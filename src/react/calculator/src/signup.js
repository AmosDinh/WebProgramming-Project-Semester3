...
function Signup() {
  ...
  function signup(data) {
    ...
    fetch("https://8080-fastiki-webprogramierun-9rrzlddhh7d.ws-eu81.gitpod.io/api/signup?username="+data.user+"&password=" + data.password,
      {
        headers: {
    ...
    <main class="form-signin w-100 m-auto">
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div class="form-floating">
                <input  {...register("user", { required: true })} type="text" class="form-control" id="floatingInput" placeholder="Username" value={username}/>
